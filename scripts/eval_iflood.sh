...
scheduler=multistep
flood_level=0.65
# seed1 - cifar10 w/ : 0.07, cifar10 w/o : 0.07, cifar100 w/ : 0.3, svhn w/ : 0.01
# seed10 - cifar10 w/ : 0.03, cifar10 w/o : ?, cifar100 w/ : 0.4, svhn w/ : ?
# seed100 - cifar10 w/ : 0.01, cifar10 w/o : ?, cifar100 w/ : 0.65, svhn w/ : ?
lr=0.0001
...
# Parsing arguments
while getopts ":d:f:m:l:w:s:t:e:p:a:b:z:" flag; do
  case "${flag}" in
    s) seed=${OPTARG};;
    t) task=${OPTARG};;
    d) dataset=${OPTARG};;
...
then
    ...
    echo "flood_level: $flood_level";
    echo "************************************************"
    python src/eval_cls.py seed=$seed experiment=iflood_cls trainer.max_epochs=$max_epochs ckpt_epoch=$ckpt_epoch \
